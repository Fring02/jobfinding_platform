...
namespace ISPH.Data.Migrations
{
    ...
    [Migration("20220823152332_AddChatMessage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ISPH.Shared.Core.Models.Advertisements.Advertisement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ISPH.Shared.Core.Models.Advertisements.AdvertisementResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISPH.Shared.Core.Models.Advertisements.FeaturedAdvertisement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ISPH.Shared.Core.Models.Messaging.Chat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ISPH.Shared.Core.Models.Messaging.Message", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ISPH.Shared.Core.Models.Advertisements.AdvertisementResponse", b =>
                {
                    b.HasOne("ISPH.Shared.Core.Models.Advertisements.Advertisement", "Advertisement")
                        .WithMany("Responses")
            ...
            modelBuilder.Entity("ISPH.Shared.Core.Models.Messaging.Message", b =>
                {
                    b.HasOne("ISPH.Shared.Core.Models.Messaging.Chat", "Chat")
                        .WithMany("Messages")
